...
public enum Content {
    ...
    Content(String code, String name, String comment, String description, String ability, List<String> values, String strength, String preference, List<String> types) {
        this.code = code;
        this.name = name;
