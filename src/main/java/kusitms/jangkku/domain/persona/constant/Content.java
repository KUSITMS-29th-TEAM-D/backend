...
public enum Content {
    CREATOR("RIA",
            ...
            "예술적 창조와 표현, 변화와 다양성을 좋아하고, 틀에 박힌것을 싫어해요.\n모호하고 자유로운 활동들을 좋아하고 관찰적, 상징적 현상의 창조적인 탐구를 수반하는 활동들에 흥미를 보여요.\n그러나 사회적이고 반복적인 활동들에서는 관심이 부족한 경향이 있어요.",
            Arrays.asList("현실형", "탐구형", "예술형"),
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Creator_front.png",
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Creator_back.png"
            ),
    INSIGHTER("RIC",
            "Insighter",
            ...
            "관찰적, 체계적이며, 물리적, 문화적 현상의 탐구를 수반하는 활동들에 흥미를 보이고, 정해진 원칙과 계획에 따라 자료들을 기록, 적리, 조직하는 일을 좋아해요.\n동시에 창의적, 자율적이며 모험적, 비체계적인 활동에는 혼란을 느끼는 경향이 있어요.",
            Arrays.asList("현실형", "탐구형", "관습형"),
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Insighter_front.png",
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Insighter_back.png"),
    INNOVATOR("REA",
            "Innovator",
            ...
            "신체적 기술들을 좋아하고, 조직의 목적을 위해 타인을 선도, 계획, 통제, 관리하는 일을 좋아하지만 체계적 활동에는 흥미가 없는 편이에요.\n예술적 창조와 표현, 변화와 다양성을 좋아하고, 틀에 박힌것을 싫어하며, 자유롭고, 상징적인 활동들을 좋아해요.",
            Arrays.asList("현실형", "기업형", "예술형"),
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Innovator_front.png",
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Innovator_back.png"
            ),
    INVENTOR("REC",
            "Inventor",
            ...
            "분명하고 체계적인 대상을 다루는 활동 내지는 신체적 기술들을 좋아하고, 조직의 목적과 경제적 이익을 얻기 위해 타인을 선도, 계획, 통제, 관리하는 일을 좋아해요.\n현실적인 직업환경에서 창의적, 모험적 능력을 발휘하여 문제를 해결하는 활동을 선호해요.",
            Arrays.asList("현실형", "기업형", "관습형"),
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Inventor_front.png",
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Inventor_back.png"),
    PROJECTOR("SIA",
            "Projector",
            ...
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Projector_front.png",
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Projector_back.png"),
    CONNECTOR("SIC",
            "Connector",
            ...
            "타인의 문제를 듣고 이해하고 도와주고 치료해주고, 봉사하는 활동들에 흥미를 보여요.\n체계적인 직업환경에서 정해진 원칙과 계획에 따라 조직하는 일을 좋아하고 친화력을 발휘하여 사람들간 상호 성장을 도모하는 활동을 좋아해요.",
            Arrays.asList("사회형", "탐구형", "관습형"),
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Connector_front.png",
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Connector_back.png"),
    ENCOURAGER("SEA",
            "Encourager",
            ...
            "타인의 문제를 듣고 이해하고 도와주고 치료해주고, 봉사하는 활동들에 흥미를 보여요.\n조직의 목적을 위해 타인을 선도, 관리하는 일과 그 결과로 얻는 위신, 인정을 얻는 활동들을 좋아해요.\n예술적 창조와 표현, 다양성을 좋아하지만, 체계적이고 구조화된 활동에는 대체적으로 흥미가 없는 편이에요.",
            Arrays.asList("사회형", "기업형", "예술형"),
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Encourager_front.png",
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Encourager_back.png"),
    ...
    ORGANIZER("SEC",
            ...
            "정해진 원칙과 계획에 따라 자료들을 기록, 적리, 조직하는 일을 좋아하고 체계적인 직업환경에서 사무적, 계산적 능력을 발휘하는 활동을 좋아해요.\n조직의 목적과 경제적 이익을 위해 타인의 문제를 듣고 이해하고 도와주는 일에 흥미를 보이지만 창의적, 자율적이며 모험적인 활동에는 혼란을 느끼기도 해요.",
            Arrays.asList("사회형", "기업형", "관습형"),
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Organizer_front.png",
            "https://kr.object.ncloudstorage.com/coolpiece-bucket/Organizer_back.png");
    ...
    Content(String code, String name, String comment, String description, String ability, List<String> values, String strength, String preference, List<String> types, String frontImgUrl, String backImgUrl) {
        this.code = code;
        this.name = name;
